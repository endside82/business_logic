...
> 현재 전체 제품은 **21개 도메인·175개 기능**이다. 아래 지도는 그중 unit 근거가 있는 **14개 도메인·117개 기능**의 온보딩 하위 집합이다. 이 표에 없는 추가 7개 도메인과 F03·F04·F08·F11의 신규 기능을 포함한 **총 58개 no-unit/source-first 기능**은 [전체 기능 정의](../prd/00_prd_items/05_feature_definitions.md)에서 이어서 확인한다.
