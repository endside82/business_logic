# Unit 근거가 있는 14개 업무 영역 플레이북

전체 제품은 21개 도메인·175개 기능이며, 이 플레이북은 그중 unit 근거를 보유한 14개 도메인·117개 기능만 같은 형식으로 정리한다. 이 표에 없는 추가 7개 도메인과 F03·F04·F08·F11의 신규 기능을 포함한 총 58개 no-unit/source-first 기능은 전체 기능 PRD와 실제 소스를 기준으로 확인한다.
