...
| 01_domain_prds/ | 20개 업무 영역별 PRD | 도메인 담당 기획자 | 도메인 목적, 기능 목록, 영역별 수용 기준 |
| 02_feature_prds/ | 168개 기능별 PRD | 기능 담당 기획자, QA | 기능 목적, 실제 계약, 정합성 판단, Gap/Risk, 수용 기준 |
...
8. `00_prd_items/05_feature_definitions.md`로 168개 기능을 훑는다.
...
- 20개 업무 영역
- 168개 기능 (v4.5 W1~W7 신규 5개 F03-13~17 + F03-18/F04-17 인구통계 + F08-14/F08-15 환불·매출 귀속 + F15·F16·F17 도메인 신설 + 2026-06-05 F18 분쟁 해결·F19 관심인·F20 고객지원 도메인 신설 및 F03-19/F03-20/F04-18/F11-07 신규 누적)
- 1180개 시나리오 (시나리오 수치화된 기능 기준)
- 545개 도식
