...
원문에는 기능별 시나리오가 총 1218개 있다(시나리오 수치화된 기능 기준 — 신규 기능 일부는 미수치화). 이 문서는 그 시나리오를 전부 다시 복사하는 대신, 기획자가 새 기능이나 화면을 검토할 때 어떤 종류의 시나리오를 빠뜨리면 안 되는지 검산하는 기준표다.

> 2026-07-08 current QA 기준: Flutter current expansion QA의 단일 truth는 `community_app/docs/testing/SCENARIO_TEST_STATUS_CURRENT.md`와 `SCENARIO_COVERAGE_DASHBOARD_CURRENT.md`다. canonical 53개 scenario는 53/53 close이고 active pending-run/merge/gap은 0이다. P83 communication runner는 존재하지만 current 53/53 canonical에는 아직 포함하지 않는다.
...
| 03 이벤트 | 20 | 165 | 8.3 | 정원, 승인, 유료 승인제, 게스트 동반 예매, 결제, 대기열, 체크인 |
| 04 클럽 | 18 | 196 | 10.9 | 권한, 멤버십, 게시판, 기금, 구독, 레퓨테이션 |
...
| 08 플랜 마켓 | 15 | 107 | 7.1 | 초안/발행, preview/share, 구매 중복, 컬렉션, 리뷰, 환불 |
| 09 프라이빗 데이팅 | 8 | 70 | 8.8 | 인증, 매칭, 채팅, 만남, 차단 |
| 10 캘린더 | 5 | 40 | 8.0 | 라우팅, 반복, 충돌, 공개 범위 |
| 11 리뷰 & 신고 | 7 | 43 | 6.1 | 작성 자격, 중복, 자기 신고, 신뢰점수, 궁합/핏 피드백 |
| 12 알림 | 6 | 38 | 6.3 | 권한, 카테고리, 방해금지, 토큰 |
| 13 프로필 & 설정 | 7 | 35 | 5.0 | 데이터 내보내기, 삭제/비활성화, 주소 |
| 14 위치 & 길찾기 | 6 | 42 | 7.0 | opt-in/out, 위치 권한, 외부 지도 |
| 15 경고 & 징계 | 9 | — | — | 신고 심사, 경고, 이의제기, 제재 집행 |
| 16 마일리지 | 8 | — | — | 정책, 적립/차감, 시즌, 랭킹, 검토 큐 |
| 17 정기모임 | 10 | 95 | 9.5 | 세션, FIXED/VARIABLE, 결제, 환불, 정산 |
| 18 분쟁 해결 | 5 | 7 | 1.4 | 직접 접수, 이의제기, 증빙, 호스트 인박스 |
| 19 관심인 | 3 | 10 | 3.3 | 관심인 등록, 캘린더, 공개범위 |
| 20 고객지원 | 3 | 16 | 5.3 | 1:1 문의, 운영 이슈, FAQ |
| 21 제공자 배정·정산 | 7 | 38 | 5.4 | 제공자 배정, 서비스비, 정산, 계약금, 정기 묶음 |
...
| 15 경고 & 징계 | O | O | O | O | O | O | O | O |
| 16 마일리지 | O | O | O | O | O | O | O | O |
| 17 정기모임 | O | O | O | O | O | O | O | O |
| 18 분쟁 해결 | O | O | O | O | O | O | O | O |
| 19 관심인 | O | O | O | O | O | O | O | O |
