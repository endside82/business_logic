...
| 03 이벤트 | 20 | 169 | 8.5 | 정원, 승인, 유료 승인제, 게스트 동반 예매, 결제, 대기열, 체크인 |
| 04 클럽 | 18 | 198 | 11.0 | 권한, 멤버십, 게시판, 기금, 구독, 레퓨테이션 |
...
| 08 플랜 마켓 | 15 | 125 | 8.3 | 초안/발행, preview/share, 구매 중복, 컬렉션, 리뷰, 환불 |
...
| 17 정기모임 | 10 | 96 | 9.6 | 세션, FIXED/VARIABLE, 결제, 환불, 정산 |
| 18 분쟁 해결 | 5 | 7 | 1.4 | 직접 접수, 이의제기, 증빙, 호스트 인박스 |
| 19 관심인 | 3 | 14 | 4.7 | 관심인 등록, 캘린더, 공개범위 |
| 20 고객지원 | 3 | 16 | 5.3 | 1:1 문의, 운영 이슈, FAQ |
| 21 제공자 배정·정산 | 7 | 66 | 9.4 | 제공자 배정, 서비스비, 정산, 계약금, 정기 묶음 |
