...
| 이 문서로 정할 것 | 14개 도메인 구조, 도메인별 기능 수와 시나리오 규모, 핵심 의존 축 |
...
| 03 | 이벤트 | 12 | 111 | 오프라인 모임을 발견, 생성, 신청, 참석, 체크인, 리뷰까지 연결한다. |
| 04 | 클럽 | 16 | 189 | 장기 커뮤니티의 가입, 운영, 게시판, 이벤트, 기금 흐름을 제공한다. |
...
| 08 | 플랜 마켓 | 13 | 107 | 코스/모임 플랜을 작성, 발행, 구매, 보관, 활용, 리뷰한다. |
