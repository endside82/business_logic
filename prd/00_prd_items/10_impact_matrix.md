...
> 갱신: 2026-06-05 신규 기능 15개 영향 행 추가, 2026-09-02 대절 버스·카풀 통합 명칭과 안전 신고 영향 갱신.

| F03-13 | 이벤트 | 이벤트 참가 선입금 | 있음 | 있음 | - | - | - |
| F03-14 | 이벤트 | 이동수단 공통 설정 | - | - | - | - | - |
| F03-15 | 이벤트 | 카풀·자차 | 있음 | - | - | - | 있음 |
| F03-16 | 이벤트 | 대절 버스와 자리 배정 | 있음 | - | - | - | 있음 |
| F03-17 | 이벤트 | 차량 좌석 배치도 운영 | - | - | - | - | - |
...
> 갱신: 2026-07-08. 도메인 15·16·21 영향 행 누락 보정. 기능 수는 175개로 유지한다.

| F15-01 | 경고 & 징계 | 내 경고 현황 & 원장 | - | - | - | - | - |
| F15-02 | 경고 & 징계 | 신고 제출 & 내 신고 관리 | 있음 | - | - | - | - |
| F15-03 | 경고 & 징계 | 이의제기 | 있음 | - | - | - | - |
| F15-04 | 경고 & 징계 | 경고 정책 & 패널티 유형 설정 | - | - | - | - | - |
| F15-05 | 경고 & 징계 | 신고 심사 | 있음 | - | - | - | - |
| F15-06 | 경고 & 징계 | 경고 부여 & 원장 조정 | 있음 | - | - | - | - |
| F15-07 | 경고 & 징계 | 이의제기 처리 | 있음 | - | - | - | - |
| F15-08 | 경고 & 징계 | 제재 집행 | 있음 | - | - | - | - |
| F15-09 | 경고 & 징계 | 검토 큐 & 대시보드/통계/감사로그 | - | - | - | - | - |
| F16-01 | 마일리지 | 내 마일리지 메인 & 월간 영수증 & 원장 | - | - | - | - | - |
| F16-02 | 마일리지 | 등급·배지·랭킹·프로필 카드 | - | - | - | - | - |
| F16-03 | 마일리지 | 시즌 | - | - | - | - | - |
| F16-04 | 마일리지 | 마일리지 정책 설정 | - | - | - | - | - |
| F16-05 | 마일리지 | 적립규칙·등급·배지·교환 프리셋 관리 | - | - | - | - | - |
| F16-06 | 마일리지 | 적립/차감/정정 집행 | 있음 | - | - | - | - |
| F16-07 | 마일리지 | 호스트 제안 | 있음 | - | - | - | - |
| F16-08 | 마일리지 | 검토 큐 & 대시보드/감사로그 | - | - | - | - | - |
| F21-01 | 제공자 배정·정산 | 제공자 배정 | - | - | - | - | - |
| F21-02 | 제공자 배정·정산 | 참가자 서비스비 분담 결제 | 있음 | 있음 | - | - | - |
| F21-03 | 제공자 배정·정산 | 제공자 정산 | 있음 | 있음 | - | - | - |
| F21-04 | 제공자 배정·정산 | 무료초대·호스트 대납 | - | 있음 | - | - | - |
| F21-05 | 제공자 배정·정산 | 환불·회수 | 있음 | 있음 | - | - | - |
| F21-06 | 제공자 배정·정산 | 계약금 선납 | - | 있음 | - | - | - |
| F21-07 | 제공자 배정·정산 | 정기모임 묶음 배정·정산 | - | 있음 | - | - | - |
