...
```text
1. 이 기능은 어느 17개 업무 영역 중 어디에 속하는가?
2. 153개 기능 인벤토리 중 기존 기능의 확장인가, 신규 기능인가?
...
처음부터 153개 기능 카드를 모두 상세화할 필요는 없다. 다만 153개 인벤토리는 반드시 유지하고, 실제 PRD나 QA가 시작되는 기능부터 카드 상세를 채우는 방식이 누락을 가장 적게 만든다.
