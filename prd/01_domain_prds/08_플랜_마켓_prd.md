...
> 문서 상태: **도메인 전환본**. 이 문서는 `business_logic/units/08_plan_market/00_overview.md`와 153개 기능 PRD 전환 상태표를 묶어, 도메인 담당자가 어떤 기능 문서를 어떤 순서로 확인해야 하는지 보여준다.
...
따라서 핵심 기능은 **크리에이터 7개 + 구매자 6개 + 운영/매출 정합 2개(F08-14·F08-15) = 총 15개**로 도출했다.
