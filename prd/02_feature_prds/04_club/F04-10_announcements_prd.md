...
|---|---|---|
| `POST /api/v1/clubs/{id}/announcements` | `ClubController#createAnnouncement` | [ClubController.java:394](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/club/controller/ClubController.java#L394) |
| `GET /api/v1/clubs/{id}/announcements` | `ClubController#getAnnouncements` | [ClubController.java:403](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/club/controller/ClubController.java#L403) |
| `DELETE /api/v1/clubs/{id}/announcements/{announcementId}` | `ClubController#deleteAnnouncement` | [ClubController.java:422](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/club/controller/ClubController.java#L422) |
