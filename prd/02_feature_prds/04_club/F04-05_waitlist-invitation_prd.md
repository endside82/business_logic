...
|---|---|---|
| `GET /api/v1/clubs/{id}/waitlist` | `ClubController#getWaitlist` | [ClubController.java:272](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/club/controller/ClubController.java#L272) |
| `POST /api/v1/clubs/{id}/waitlist/{waitId}/approve` | `ClubController#approveApplication` | [ClubController.java:280](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/club/controller/ClubController.java#L280) |
| `POST /api/v1/clubs/{id}/waitlist/{waitId}/reject` | `ClubController#rejectApplication` | [ClubController.java:289](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/club/controller/ClubController.java#L289) |
| `POST /api/v1/clubs/{id}/invitations` | `ClubController#inviteMember` | [ClubController.java:300](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/club/controller/ClubController.java#L300) |
| `POST /api/v1/clubs/{id}/invitations/{invitationId}/accept` | `ClubController#acceptInvite` | [ClubController.java:309](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/club/controller/ClubController.java#L309) |
| `POST /api/v1/clubs/{id}/invitations/{invitationId}/decline` | `ClubController#declineInvite` | [ClubController.java:320](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/club/controller/ClubController.java#L320) |
