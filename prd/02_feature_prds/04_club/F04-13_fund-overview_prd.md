...
|---|---|---|
| `GET /api/v1/clubs/{id}/fund` | `ClubController#getFund` | [ClubController.java:467](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/club/controller/ClubController.java#L467) |
