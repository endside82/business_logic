...
|---|---|---|
| `GET /api/v1/date/matches` | `DateMatchController#getMatches` | [DateMatchController.java:37](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/privatedate/controller/DateMatchController.java#L37) |
| `GET /api/v1/date/matches/{matchId}` | `DateMatchController#getMatch` | [DateMatchController.java:45](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/privatedate/controller/DateMatchController.java#L45) |
