...
|---|---|---|
| `GET /api/v1/date/profile/views` | `DateProfileController#getProfileViews` | [DateProfileController.java:86](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/privatedate/controller/DateProfileController.java#L86) |
