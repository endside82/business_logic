...
|---|---|---|
| `GET /api/v1/date/blocks` | `DateBlockController#listBlocks` | [DateBlockController.java:29](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/privatedate/controller/DateBlockController.java#L29) |
| `POST /api/v1/date/blocks/{targetUserId}` | `DateBlockController#blockUser` | [DateBlockController.java:50](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/privatedate/controller/DateBlockController.java#L50) |
| `DELETE /api/v1/date/blocks/{targetUserId}` | `DateBlockController#unblockUser` | [DateBlockController.java:69](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/privatedate/controller/DateBlockController.java#L69) |
