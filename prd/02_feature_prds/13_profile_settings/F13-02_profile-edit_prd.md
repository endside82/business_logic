...
|---|---|---|
| `PATCH /api/v1/users/me` | `UserController#updateMyProfile` | [UserController.java:66](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/account/controller/UserController.java#L66) |
