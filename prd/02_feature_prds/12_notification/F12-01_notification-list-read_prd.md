...
|---|---|---|
| `GET /api/v1/notifications` | `NotificationController#getNotifications` | [NotificationController.java:35](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/notification/controller/NotificationController.java#L35) |
| `GET /api/v1/notifications/unread-count` | `NotificationController#getUnreadCount` | [NotificationController.java:52](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/notification/controller/NotificationController.java#L52) |
| `PATCH /api/v1/notifications/{notificationId}/read` | `NotificationController#markAsRead` | [NotificationController.java:58](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/notification/controller/NotificationController.java#L58) |
| `PATCH /api/v1/notifications/read-all` | `NotificationController#markAllAsRead` | [NotificationController.java:66](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/notification/controller/NotificationController.java#L66) |
| `DELETE /api/v1/notifications/{notificationId}` | `NotificationController#deleteNotification` | [NotificationController.java:73](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/notification/controller/NotificationController.java#L73) |
