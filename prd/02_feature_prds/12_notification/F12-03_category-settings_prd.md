...
|---|---|---|
| `GET /api/v1/notifications/settings` | `NotificationController#getSettings` | [NotificationController.java:81](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/notification/controller/NotificationController.java#L81) |
| `PATCH /api/v1/notifications/settings` | `NotificationController#updateSettings` | [NotificationController.java:99](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/notification/controller/NotificationController.java#L99) |
