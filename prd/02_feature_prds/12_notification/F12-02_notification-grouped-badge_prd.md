...
|---|---|---|
| `GET /api/v1/notifications/grouped` | `NotificationController#getGroupedNotifications` | [NotificationController.java:43](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/notification/controller/NotificationController.java#L43) |
