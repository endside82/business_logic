...
|---|---|---|
| `DELETE /api/v1/auth/social/{providerType}` | `AuthController#unlinkSocial` | [AuthController.java:77](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/account/controller/AuthController.java#L77) |
