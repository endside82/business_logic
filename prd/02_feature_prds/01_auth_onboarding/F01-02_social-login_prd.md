...
|---|---|---|
| `POST /api/v1/auth/social` | `AuthController#socialLogin` | [AuthController.java:66](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/account/controller/AuthController.java#L66) |
