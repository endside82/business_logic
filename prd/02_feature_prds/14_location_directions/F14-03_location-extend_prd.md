...
|---|---|---|
| `POST /api/v1/events/{eventId}/location/extend` | `LocationController#extendShare` | [LocationController.java:75](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/location/controller/LocationController.java#L75) |
