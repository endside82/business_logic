...
|---|---|---|
| `GET /api/v1/events/{eventId}/directions` | `DirectionsController#getDirections` | [DirectionsController.java:29](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/directions/controller/DirectionsController.java#L29) |
| `GET /api/v1/events/{eventId}/attendees/distances` | `DirectionsController#getAttendeeDistances` | [DirectionsController.java:37](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/directions/controller/DirectionsController.java#L37) |
