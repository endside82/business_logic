...
|---|---|---|
| `GET /api/v1/events/{eventId}/photos` | `EventPhotoController#getPhotos` | [EventPhotoController.java:54](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/event/controller/EventPhotoController.java#L54) |
| `POST /api/v1/events/{eventId}/photos` | `EventPhotoController#uploadPhoto` | [EventPhotoController.java:62](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/event/controller/EventPhotoController.java#L62) |
| `DELETE /api/v1/events/{eventId}/photos/{photoId}` | `EventPhotoController#deletePhoto` | [EventPhotoController.java:82](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/event/controller/EventPhotoController.java#L82) |
