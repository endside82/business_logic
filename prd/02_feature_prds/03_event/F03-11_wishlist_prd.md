...
|---|---|---|
| `POST /api/v1/events/{eventId}/wishlist` | `WishlistController#add` | [WishlistController.java:36](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/event/controller/WishlistController.java#L36) |
| `DELETE /api/v1/events/{eventId}/wishlist` | `WishlistController#remove` | [WishlistController.java:44](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/event/controller/WishlistController.java#L44) |
| `GET /api/v1/users/me/wishlist` | `WishlistController#getMyWishlist` | [WishlistController.java:52](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/event/controller/WishlistController.java#L52) |
