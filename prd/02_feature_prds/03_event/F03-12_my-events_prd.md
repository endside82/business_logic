...
|---|---|---|
| `GET /api/v1/events/my` | `EventController#listMyEvents` | [EventController.java:150](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/event/controller/EventController.java#L150) |
...
| `GET /api/v1/events/{eventId}/capacity/logs` | `CapacityController#getLogs` | [CapacityController.java:127](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/capacity/controller/CapacityController.java#L127) |
