...
|---|---|---|
| `GET /api/v1/hosting-tickets` | `HostingTicketController#getAvailableTickets` | [HostingTicketController.java:29](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/payment/controller/HostingTicketController.java#L29) |
| `POST /api/v1/hosting-tickets/purchase` | `HostingTicketController#purchaseTicket` | [HostingTicketController.java:35](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/payment/controller/HostingTicketController.java#L35) |
