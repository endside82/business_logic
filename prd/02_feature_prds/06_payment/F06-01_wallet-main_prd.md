...
|---|---|---|
| `GET /api/v1/wallet` | `WalletController#getWallet` | [WalletController.java:62](https://github.com/endside82/community_api/blob/19e968a1aa128d3cf8b980413e87c397fffe91b3/src/main/java/com/endside/community/payment/controller/WalletController.java#L62) |
